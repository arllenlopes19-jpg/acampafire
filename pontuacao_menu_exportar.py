...
def remover_equipe():
    equipe = input("Digite o nome da equipe que deseja remover: ")
    if equipe in pontuacoes:
        del pontuacoes[equipe]
        salvar_pontuacoes(pontuacoes)
        print(f"Equipe {equipe} removida com sucesso!")
    else:
...
def exportar_txt():
    ...
    print("Ranking exportado para ranking_final.txt")
...
def exportar_csv():
    ...
    print("Ranking exportado para ranking_final.csv")
...
def menu():
    while True:
        ...
        print("5. Exportar ranking para TXT")
        print("6. Exportar ranking para CSV")
        print("7. Sair")
