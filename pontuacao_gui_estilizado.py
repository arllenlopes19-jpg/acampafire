...
root.configure(bg="#f0f8ff")  # cor de fundo azul clara
...
tk.Button(root, text="Exportar Ranking CSV", command=exportar_csv, **btn_style).grid(row=5, column=0, columnspan=2, padx=5, pady=5)
